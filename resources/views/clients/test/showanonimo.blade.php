<x-main-layout>
    <!-- title -->
    @section('title')Detalles del Test Anónimo @endsection
              ...
              <div class="card">
                ...
                <div class="card-body">
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-6">
                            @if (!empty($test))
                              <a href="{{route('test_anonimo.downloadpdf', $author_ramdon)}}" class="btn btn-outline-info btn-fw float-right ml-2"><i class="fas fa-print"></i>Descargar Test</a>
                            @endif
                  ...
                  <p class="card-description">
                    @if (!empty($test))
                        A continuación podrá ver en detalle las respuestas del test del usuario <strong>Anónimo</strong> 
                    @else
                        El usuario <strong>Anónimo</strong> no ha realizado el test!
                    @endif
                  </p>
