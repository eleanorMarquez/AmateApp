    ...
    <div class="row py-4">
      <div class="col-md-6 offset-md-3 text-center">
        ...
        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
            <input id="upload" type="file" onchange="readURL(this);" name="imgLogo" value="{{$even->image}}" class="form-control border-0">
        ...
        <!-- Uploaded image area-->
        <div class="image-area mt-4"><img id="imageResult" src="{{$even->image}}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
      </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" value="{{$even->title}}" id="title" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="date" id="date" value="{{$even->date}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="time" class="form-control" name="hour" id="hour" placeholder="" value="{{$even->hour}}" required>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="ubication" id="ubication" value="{{$even->ubication}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="hidden" id="description" name="description" value="{{$even->description}}">
