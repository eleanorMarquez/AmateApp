<form class="forms-sample" id="quickForm">
    ...
    <div class="row py-4">
      <div class="col-md-6 offset-md-3 text-center">
        ...
        <!-- Uploaded image area-->
        <div class="image-area mt-4"><img id="imageResult" src="{{$enity->image}}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
      </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="entity" id="title" value="{{$enity->entity}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="area_of_contact" id="area_of_contact" value="{{$enity->area_of_contact}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="phones" id="phones" value="{{$enity->phones}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="ubication" id="ubication" value="{{$enity->ubication}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="facebook" id="facebook" value="{{$enity->facebook}}" placeholder="">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="instagram" id="instagram" value="{{$enity->instagram}}" placeholder="">
            </div>
        </div>
