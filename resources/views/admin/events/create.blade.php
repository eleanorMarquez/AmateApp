<x-main-layout>
    <!-- title -->
    @section('title')Crear Evento @endsection
    ...
    <div class="main-panel"> 
        <div class="content-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('evento.index') }}">Inicio</a></li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Registra los eventos que se mostrarán en la página principal.
                  </p>
                  <!----- make register of user ---->
                  <x-form-register-event></x-form-register-event>
                </div>
              </div>
          </div>
          </div>
      ...
      function showFileName( event ) {
        ...
        infoArea.textContent = 'File name: ' + fileName;
            ...
            messages: {
              ...
              description: {
                required: "Por favor digite una descripción",
              },
            },
            errorElement: 'span',
                    ...
                    $.ajax({
                       ...
                       if (!respuesta.error) {
                          ...
                          Swal.fire({
                            ...
                            setTimeout(function(){
                                location.href = "{{route('evento.index')}}";
                            },2000);
