        ...
        <div class="content-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{$evento->title}}</li>
            </ol>
          </nav>
        <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Actualizar Información de <strong>{{$evento->title}}</strong> 
                  </p>
                  <!----- make register of user ---->
                  <x-form-edit-event idevent="{{$evento->id}}"></x-form-edit-event>
                </div>
              </div>
          </div>
          </div>
