          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                           <h4 class="card-title">Crear nueva noticia</h4>
                        </div>
                        <div class="col-sm-6">
                        </div>
                    </div>
                  <p class="card-description">
                    Registra las noticias que se mostrarán en la página principal.
                  </p>
                  <!----- make register of user ---->
                  <x-form-register-new></x-form-register-new>
                </div>
              </div>
          </div>
          </div>
                    ...
                    $.ajax({
                       ...
                       if (!respuesta.error) {
                          ...
                          Swal.fire({
                            ...
                            setTimeout(function(){
                                location.href = "{{route('noticia.index')}}";
                            },2000);
