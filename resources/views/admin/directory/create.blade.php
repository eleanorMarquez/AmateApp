<x-main-layout>
    <!-- title -->
    @section('title')Registrar Entidad @endsection
    ...
    <div class="main-panel"> 
        <div class="content-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('directorio.index') }}">Inicio</a></li>
              <li class="breadcrumb-item active" aria-current="page">Registrar Entidad</li>
            </ol>
          </nav>
        <div class="row">
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                           <h4 class="card-title">Registrar Nueva Entidad</h4>
                        </div>
                        <div class="col-sm-6">
                        </div>
                    </div>
                  <p class="card-description">
                    Registra la entidad definida como ruta de atención
                  </p>
                  <!----- make register of entity ---->
                  <x-form-register-directory></x-form-register-directory>
                </div>
              </div>
          </div>
          </div>
                ...
                // agregar data
                    ...
                    $.ajax({
                       ...
                       if (!respuesta.error) {
                          ...
                          Swal.fire({
                                title: 'Entidad guardada exitosamente.',
                                icon: 'success',
                                button: true,
                                timer: 2000
                            });
